            ...
            <Container maxWidth="lg" className={my_classes.blog}>
                <Grid container spacing={3}>
                                ...
                                <Card sx={{ maxWidth: 345 }}>
                                    ...
                                    <CardActions className={my_classes.cardActions}>
                                        <Box className={my_classes.author}>
                                            <Avatar src="https://media.istockphoto.com/photos/headshot-of-cheerful-handsome-man-with-trendy-haircut-and-eyeglasses-picture-id1171169127?s=612x612"/>
                                            <Box ml={2}>
                    ...
                    <Card sx={{ maxWidth: 345 }}>
                                    ...
                                    <CardActions className={my_classes.cardActions}>
                                        <Box className={my_classes.author}>
                                            <Avatar src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGZhY2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=1000&q=60"/>
                                            <Box ml={2}>
                                                <Typography variant="subtitle2" component="p">
